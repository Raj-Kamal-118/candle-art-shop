          ...
          <form onSubmit={handleSendOTP} className="space-y-4">
            <div>
              ...
              <div className="flex gap-2 items-center border border-brown-300 dark:border-amber-900/50 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-amber-400">
                ...
                <input
                  ...
                  maxLength={10}
                  required
                  className="flex-1 px-2 py-3 text-base sm:text-sm bg-transparent focus:outline-none dark:text-amber-100 dark:placeholder:text-amber-100/30"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 text-base sm:text-sm border border-brown-300 dark:border-amber-900/50 rounded-xl bg-transparent focus:outline-none focus:ring-2 focus:ring-amber-400 dark:text-amber-100 dark:placeholder:text-amber-100/30"
              />
            </div>
