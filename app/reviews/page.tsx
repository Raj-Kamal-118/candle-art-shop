...
export default async function ReviewsPage() {
  ...
  return (
    <InfoShell
      ...
      title={
        <>
          Stories of <span className="text-coral-600 italic">Warmth</span>
        </>
      }
      subtitle="Read what our wonderful customers have to say about their experiences with our handcrafted pieces."
    >
