                  ...
                  >
                    ...
                    >
                      <div className="font-mono text-xs text-brown-600 dark:text-amber-100/70">
                        <div className="flex items-center gap-1">
                          ...
                          {isGift && (
                            <span className="ml-1 bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300 text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider">
                              GIFT
                            </span>
                          )}
                        </div>
                    ...
                    {expanded === order.id && (
                      <div className="px-5 pb-5 bg-cream-50 dark:bg-[#12101e] border-t border-cream-200 dark:border-amber-900/30">
                                        ...
                                        Object.keys(item.customizations)
                                          ...
                                          <div className="flex flex-wrap gap-1 mt-1.5">
                                            {Object.entries(
                                              ...
                                              <span
                                                key={k}
                                                className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-medium bg-amber-50 dark:bg-amber-900/20 text-brown-600 dark:text-amber-100/70 border border-amber-200 dark:border-amber-900/30"
                                              >
                            ...
                            <div className="mt-4 bg-white dark:bg-[#1a1830] border border-cream-100 dark:border-amber-900/20 rounded-xl p-4 text-sm space-y-2">
                              ...
                              {greetingCardFee > 0 && (
                                <div className="flex justify-between text-brown-600 dark:text-amber-100/70">
                                  ...
                                  <span>₹{greetingCardFee.toFixed(2)}</span>
                                </div>
                              )}
                              {Math.round(
                                order.total -
                        ...
                        {isGift && (
                          <div className="mt-6 bg-amber-50/50 dark:bg-amber-900/10 rounded-xl p-4 border border-amber-200/60 dark:border-amber-900/30">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-violet-500 dark:text-violet-400/70">
                              — excluded from revenue &amp; order count on
                              dashboard
                            </span>
                          </div>
                          <button
