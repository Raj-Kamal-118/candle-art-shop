          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="w-14 h-14 rounded-2xl cursor-pointer border-2 border-cream-200 p-1"
                />
                <span className="text-sm text-brown-500 font-mono uppercase">
                  {color}
                </span>
              </div>
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full p-3 bg-cream-50 border border-cream-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:outline-none text-brown-800"
              >
                {SCENTS.map((s) => (
                ...
                <div className="space-y-2">
                  {WAX_TYPES.map((w) => (
                    ...
                    >
                      ...
                      />
                      <span className="text-sm text-brown-700">{w}</span>
                    </label>
                  ))}
                </div>
              </div>
        ...
        <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-8">
          <div className="bg-cream-100/50 p-8 rounded-3xl border border-cream-200 overflow-hidden h-[450px] flex flex-col items-center justify-center relative">
            ...
            <motion.div
              ...
              className="relative w-64 h-64 mt-8 rounded-2xl overflow-hidden shadow-md bg-white border border-cream-200"
            >
              <img
